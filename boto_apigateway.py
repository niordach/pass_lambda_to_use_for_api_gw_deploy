...
class _Swagger(object):
    ...
    REQUEST_TEMPLATE_VALUE = ('#set($inputRoot = $input.path(\'$\'))\n'
                              '{\n'
                              '"header_params" : {\n'
    ...
    def _parse_method_data(self, method_name, method_data):
        ...
        if method_name == 'options':
            ...
            ctypes = method_data.get('consumes', ['application/json'])
            request_templates = {ct: _Swagger.REQUEST_TEMPLATE_VALUE for ct in ctypes}
